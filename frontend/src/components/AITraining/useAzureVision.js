...
//         <h2 className="mainTitleSubLogo">Computer Vision Analysis</h2>
...
//               ></input>
//               <button onClick={onFileUrlEntered}>Car Search</button>
//             </div>
//           </div>
//         )}
